...
export default function Main() {
    // Emma's Upgraded State Machine: 
    // 1 = Booking Details, 2 = Contact Info, 3 = Success Toast
    const [step, setStep] = useState(1);

    // Moves us from the Date/Time form to the Contact form
    const handleNext = (e) => {
        e.preventDefault();
        setStep(2);
    };

    // Submits the final contact form and triggers the toast
    ...
    // Textareas need a bit of a tweak so they don't look rubbish
    ...
    // A secondary button style for going backwards!
